...
class Solution:
    ...
    def maxProfit(self, k, prices):
        ...
        V, P = self.pairs(prices)
        return self.compute_max_profits(k, prices, V, P)


    def pairs(self, prices):
        # compute P, V pair.
        length = len(prices)
        if length <= 2:
            return 0
